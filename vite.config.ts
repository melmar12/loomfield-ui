...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@NumberInput': path.resolve(
        __dirname,
        'src/components/NumberInput/NumberInput.tsx'
      ),
      '@RadioGroup': path.resolve(
        __dirname,
      ...
      '@SuccessScreen': path.resolve(
        __dirname,
        'src/components/SuccessScreen/SuccessScreen.tsx'
      ),
      '@TextArea': path.resolve(
        __dirname,
        'src/components/TextArea/TextArea.tsx'
      ),
      '@TextInput': path.resolve(
        __dirname,
        'src/components/TextInput/TextInput.tsx'
      ),
      '@FormField': path.resolve(
        __dirname,
